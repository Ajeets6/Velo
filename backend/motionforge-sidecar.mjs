...
export class MotionForgeSidecar {
  constructor({ executable, startupMs = 10000, log = () => {}, fetchImpl = fetch, spawnProcess = spawn, environment = async () => process.env } = {}) { this.executable = executable; this.startupMs = startupMs; this.log = log; this.fetch = fetchImpl; this.spawn = spawnProcess; this.environment = environment; this.child = null; this.baseUrl = null; this.secret = null; this.starting = null; }
  async start() {
